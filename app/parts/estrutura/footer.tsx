...
const Footer = () => {
    return (
        <footer className="bg-purple-700 py-8 md:py-12 block text-white p-4">
            <div className="container mx-auto px-4">
                <div className="flex items-center flex-col">
                    ...
                    <Link href={ContentLinks.whatsapp}>
                        <button type="button" className="w-full border border-zinc-200 text-white transition font-medium rounded-full my-2 py-3 px-8 flex justify-center items-center text-sm lg:text-base gap-3">
