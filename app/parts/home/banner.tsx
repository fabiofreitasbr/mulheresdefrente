...
export default function Banner() {
    return (
        <>
            <div id="banner" className="relative overflow-hidden bg-cover bg-banner bg-center min-h-[20rem] md:h-[36rem] lg:h-[42rem] 2xl:h-[48rem] pt-10">
                    ...
                    <div className="md:flex items-center justify-center h-full">
                        <div className="w-full relative z-50 md:w-1/2 h-full flex flex-col justify-center mb-4 ">
                            <div className=" container mx-auto max-w-lg">
                                ...
                                <Image className="w-1/2 md:mx-auto" width={624} height={535} alt="Logo - Mulheres de Frente - Juntas Pela Igualdade" src="/img/logo.png" />
                        ...
                        <div className="absolute z-10 md:relative -right-[65%] sm:-right-[55%] md:right-auto bottom-0 md:bottom-auto md:w-1/2 bg-feature bg-contain bg-bottom bg-no-repeat h-full">
