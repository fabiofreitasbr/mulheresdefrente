            ...
            <section className="z-10 relative">
                <div className="z-20 relative container mx-auto px-4">
                    <div className="block lg:flex items-end">
                        <div className="lg:w-2/6 flex justify-content items-end px-4">
                            <Image src="/img/about.png" width={720} height={405} alt="Estúdio Grape" className="w-full mx-auto" />
                        </div>
                        <div className="lg:w-4/6 px-4">
                            <div className="text-base text-justify md:text-right md:text-lg text-zinc-700 my-10 md:my-16">
                                <h2 className="text-right text-xl md:text-4xl py-4 text-purple-700 font-playfair font-semibold">Caminhada Juntas pela Igualdade</h2>
